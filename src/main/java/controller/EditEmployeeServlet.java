...
public class EditEmployeeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		EmployeeList employeeToUpdate = elh.searchForEmpFirstNameById(tempId);
		employeeToUpdate.setEmpFirstName(empFirstName);
		employeeToUpdate.setEmpLastName(empLastName);
		elh.updateEmpFirstName(employeeToUpdate);
